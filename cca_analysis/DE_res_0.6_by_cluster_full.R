...
save(dds_cardio_full, file = paste0("/n/data1/cores/bcbio/PIs/calum_macrae/macrae_scRNASeq_cardiomyocytes/cca_analysis/DE_KO_WT_results/by_cluster/deseqObject_cardio_full_cluster_",cluster_n,".Rdata"))
rm(list = ls())
}
